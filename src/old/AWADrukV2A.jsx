...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-left::after {
    ...
    background: linear-gradient(180deg, transparent, #9fb8d8, transparent);
  }
  .hero-eyebrow { display: flex; align-items: center; gap: 10px; margin-bottom: 28px; }
  .hero-eyebrow-line { width: 28px; height: 2px; background: #7a9ec0; }
  .hero-eyebrow-text { font-size: 11px; font-weight: 700; letter-spacing: 2.5px; text-transform: uppercase; color: #5a82aa; }
  .hero h1 {
    font-family: 'Playfair Display', serif;
  ...
  .btn-outline-light:hover { border-color: #7a9ec0; background: rgba(188,204,230,0.15); }
  ...
  .offer-card:hover { transform: translateY(-6px); border-color: #9fb8d8; box-shadow: 0 16px 48px rgba(122,158,192,0.18); }
  .offer-img-slot {
  ...
  .offer-card:hover .offer-img-slot { background: #9fb8d8; }
  ...
  .order-step-num { font-family: 'Playfair Display', serif; font-size: 48px; font-weight: 900; color: rgba(122,158,192,0.55); line-height: 1; margin-bottom: 16px; display: block; }
  ...
  .about-img-slot::before {
    ...
    background: radial-gradient(circle at 20% 80%, rgba(255,255,255,0.35) 0%, transparent 60%),
  ...
  .about-feat-card:hover { border-color: #9fb8d8; box-shadow: 0 4px 16px rgba(122,158,192,0.15); }
  ...
  .map-slot { margin-top: 24px; height: 160px; border-radius: 12px; background: #bccce6; border: 1px solid var(--border); display: flex; flex-direction: column; align-items: center; justify-content: center; font-size: 28px; color: rgba(42,35,24,0.4); }
  .map-slot p { font-size: 10px; text-transform: uppercase; letter-spacing: 1px; color: var(--textd2); margin-top: 8px; }

  .contact-form { background: #e6d6bc; border: 1px solid var(--border); border-radius: 20px; padding: 42px 40px; }
  ...
  .form-field input:focus, .form-field textarea:focus { border-color: #9fb8d8; box-shadow: 0 0 0 3px rgba(159,184,216,0.2); }
  ...
  .footer-inner a:hover { color: #bccce6; }
      ...
      <div className="main">
        ...
        <section id="o-nas" className="about-section">
          <div className="about-inner">
            <div className="sec-label"><div className="sec-label-line"/><span className="sec-label-text">Kim jesteśmy</span></div>
        ...
        <section id="kontakt" className="contact-section">
          <div className="contact-inner">
            <div className="sec-label"><div className="sec-label-line"/><span className="sec-label-text">Kontakt</span></div>
